...
public:
  ...
  {
    pub = this->create_publisher<sensor_msgs::msg::Image>("/rb1_base/front_rgbd_camera/rgb/image_raw", 100);
  }
...
int main(int argc, char * argv[])
{
  ...
  ros::NodeHandle n;
  ros::Subscriber sub = n.subscribe("/rb1_base/front_rgbd_camera/rgb/image_raw", 100, TFCallback);
